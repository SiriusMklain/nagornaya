        ...
        <div class='col-xs-12' data-entity="parent-container">
            ...
            $APPLICATION->IncludeComponent(
                ...
                array(
                    ...
                    'PROPERTY_CODE' => (isset($arParams['LIST_PROPERTY_CODE']) ? ["ARTNUMBER"]: []),
                    'PROPERTY_CODE_MOBILE' => $arParams['LIST_PROPERTY_CODE_MOBILE'],
                    ...
                    'SECTION_ID_VARIABLE' => $arParams['SECTION_ID_VARIABLE'],
                    'PRODUCT_QUANTITY_VARIABLE' => $arParams['PRODUCT_QUANTITY_VARIABLE'],
                    'PRODUCT_PROPS_VARIABLE' => ["ARTNUMBER"],
                    'CACHE_TYPE' => $arParams['CACHE_TYPE'],
                    'CACHE_TIME' => $arParams['CACHE_TIME'],
                    'CACHE_FILTER' => $arParams['CACHE_FILTER'],
                    'CACHE_GROUPS' => $arParams['CACHE_GROUPS'],
                    ...
                    'USE_PRODUCT_QUANTITY' => $arParams['USE_PRODUCT_QUANTITY'],
                    'ADD_PROPERTIES_TO_BASKET' => (isset($arParams['ADD_PROPERTIES_TO_BASKET']) ? $arParams['ADD_PROPERTIES_TO_BASKET'] : ''),
                    'PARTIAL_PRODUCT_PROPERTIES' => (isset($arParams['PARTIAL_PRODUCT_PROPERTIES']) ? ["ARTNUMBER"] : ''),
                    'PRODUCT_PROPERTIES' => (isset($arParams['PRODUCT_PROPERTIES']) ? ["ARTNUMBER"] : []),
