...
(function() {
	...
	BX.Sale.OrderAjaxComponent = {
		...
		createPaySystemItem: function(item)
		{
			...
			logoNode = BX.create('h4', {text: item.NAME});
...
/*
		...
		editDeliveryItems: function(deliveryNode)
		{
			...
			var deliveryItemsContainer = BX.create('DIV', {props: {className: 'col-sm-12 bx-soa-pp-item-container', style: 'margin-top: 115px;'}}),
				deliveryItemNode, k;
