...
?>
    <div class="bx-catalog-element bx-<?= $arParams['TEMPLATE_THEME'] ?>" id="<?= $itemIds['ID'] ?>" itemscope
        ...
        <div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-xl-5 offset-xl-1">
                        ...
                        <div class="col-xs-12">
                            ...
                            if ($haveOffers) {
                                                ...
                                                <div class="card card--light">
                                                    <div class="card-header">
                                                        <div class="row">
                                                            ...
                                                            <div class="col">
                                                                <p>Стоимость зеркала рассчитывается исходя из необходимого вам размера.
                                ...
                                if ($arResult['MODULES']['catalog'] && $arResult['OFFER_GROUP']) {
                                    $APPLICATION->IncludeComponent(
                                        'bitrix:catalog.set.constructor', '.default', array(
                                        'CUSTOM_SITE_ID' => isset($arParams['CUSTOM_SITE_ID']) ? $arParams['CUSTOM_SITE_ID'] : null,
                                        'IBLOCK_ID' => $arParams['IBLOCK_ID'],
                                        'ELEMENT_ID' => $arResult['ID'],
                                        'PRICE_CODE' => $arParams['PRICE_CODE'],
                    ...
                    <div class="row go-calc">
                        <div class="col-md-8">
                            <p>
                                Не нашли необходимый вам размер? <br>
                                Вы можете
                                рассчитать индивидуально.</p>
                        ...
                        <div class="col-md-4">
                            <div data-entity="main-button-container">
                                <div>
                                    <div class="product-item-detail-info-container">
                                        <a style="background: #EDEEF0;" class="btn product-item-detail-buy-button"
                                           href="javascript:void(0);">
        ...
        <?/*
<!--Small Card-->
<div class="product-item-detail-short-card-fixed active" id="<?= $itemIds['SMALL_CARD_PANEL_ID'] ?>">
        ...
        <table>
            <tr>
                ...
                <td rowspan="2" class="product-item-detail-short-card-btn"
                    style="display: <?= ($actualItem['CAN_BUY'] ? '' : 'none') ?>;" data-entity="panel-add-button">
                ...
                <?
                                                                                                    ...
                                                                                                    if ($showBuyBtn) {
                                                                                                        ?>
                <td rowspan="2" class="product-item-detail-short-card-btn"
                    style="display: <?= ($actualItem['CAN_BUY'] ? '' : 'none') ?>;" data-entity="panel-buy-button">
                    <a class="btn <?= $buyButtonClassName ?> product-item-detail-buy-button"
                        id="<?= $itemIds['BUY_LINK'] ?>" href="javascript:void(0);">
                        <span><?= $arParams['MESS_BTN_BUY'] ?></span>
                    </a>
