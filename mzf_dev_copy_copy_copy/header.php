...
<head>
    ...
    ym(31938491, "init", {
        ...
        <div><img src="https://mc.yandex.ru/watch/49127092" style="position:absolute; left:-9999px;" alt="" /></div>
    </noscript> <!-- /Yandex.Metrika counter -->
    <!-- /Yandex.Metrika counter -->
    <!-- Global site tag (gtag.js) - Google AdWords: 868737201 -->
    <script data-skip-moving="true" async="true" src="https://www.googletagmanager.com/gtag/js?id=AW-868737201">
    </script>
    ...
    gtag('config', 'AW-868737201');
    gtag('config', 'AW-868737201/yf8oCNv753oQscGfngM', {
        'phone_conversion_number': '8 (495) 980-53-73'
    });
    </script>
    <script data-skip-moving="true">
    ...
    ga('create', 'UA-124891721-1', 'auto', {
        'allowLinker': true,
        'name': 'md'
    });
    ga('require', 'linker');
    ga('linker:autoLink', ['steklo17.ru', 'skinali17.ru', 'dysh17.ru', 'baget17.ru', 'dver17.ru', 'nagornaya17.ru',
        'metall17.ru', 'vitrag17.ru', 'peregorodki17.ru'
    ]);
    ga('set', 'userId', 'USER_ID');
    ga('md.send', 'pageview');
    </script>
    ...
    <noscript><img height="1" width="1" style="display:none"
            src="https://www.facebook.com/tr?id=1483923335082244&ev=PageView&noscript=1" /></noscript>
    ...
    function() {
            VK.Retargeting.Init("VK-RTRG-407650-30Q6v"), VK.Retargeting.Hit()
        }, document.head.appendChild(t)
    }();
    </script><noscript><img src="https://vk.com/rtrg?p=VK-RTRG-407650-30Q6v" style="position:fixed; left:-999px;"
            alt="" /></noscript>
        ...
        <header class="header fixed-top">
            ...
            <div class="header__bottom">
                <nav class="navbar navbar-expand-lg navbar-dark">
                    <div class="container-md">
                        <a class="navbar-brand" href="/?test=Y"><img src="<?=SITE_TEMPLATE_PATH?>/images/new/logo.svg" alt="Нагорная 17" class="navbar-logo"></a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            $APPLICATION->IncludeComponent(
                                "bitrix:search.title", "mzf-new", array(
                                "NUM_CATEGORIES" => "0",
                                "TOP_COUNT" => "5",
                                "CHECK_DATES" => "N",
                                "SHOW_OTHERS" => "Y",
                        ...
                        ?>
                        <div id="Fav" style="display:none;"><?count($arCountFavorites)?></div>
    ...
    <div class="page">
        <div class="page-header page-header--light">
            <div class="page-header__thumbnail">
                <img alt="Доставка" src="<?=SITE_TEMPLATE_PATH?>/images/new/bg-delivery.png" class="page-header__image">
            </div>
