...
<div class="swiper-container swiper-product mb-4 bx-<?=$arParams['TEMPLATE_THEME']?>" data-entity="<?=$containerName?>">
		...
		foreach ($arResult['ITEM_ROWS'] as $rowData)
		{
			...
			?>
				...
				switch ($rowData['VARIANT'])
				{
					case 0:
						?>
						<div id="12" class="col-xs-12 product-item-small-card">
							<div class="row">
					...
					case 1:
						?>
						<div id="13" class="col-xs-12 product-item-small-card">
							<div class="row">
								<?
