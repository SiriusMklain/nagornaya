...
<? if ($isFilter || $isSidebar):
    ...
    <div class="col-12 col-lg-4 col-xl-3">
            ...
            <div class="bx-sidebar-block sticky-md-top">
...
<!--                --><?//
//                $APPLICATION->IncludeComponent(
//                    "bitrix:catalog.section.list", "new-treee", array(
//                    "IBLOCK_TYPE" => 95,
...
//                                array('showcount'))?><!--" --><?//=$showcount == 12 ? "class='active'" : ""?><!--Показать: меньше</a></li>-->
                        <li> <a class="dropdown-item" href="<?=$APPLICATION->GetCurPageParam('showcount=24',
                                array('showcount'))?>" <?=$showcount == 24 ? "class='active'" : ""?>>Показать: меньше</a></li>
                        <li> <a class="dropdown-item" href="<?=$APPLICATION->GetCurPageParam('showcount=48',
                                array('showcount'))?>" <?=$showcount == 48 ? "class='active'" : ""?>>Показать: больше</a></li>
                    </ul>
                </div>
<!--                <div class="dropdown">-->
