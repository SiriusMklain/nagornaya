...
<div class="owl-carousel owl-theme catalog-section bx-<?=$arParams['TEMPLATE_THEME']?>" data-entity="<?=$containerName?>">
	<?
									...
									<div class="col-xs-6 col-md-3">
										...
										$APPLICATION->IncludeComponent(
											...
											array(
												...
												'PARAMS' => $generalParams
													+ array('SKU_PROPS' => $arResult['SKU_PROPS'][$item['IBLOCK_ID']], ["USE_VOTE_RATING"] => "Y")
											),
											$component,
											array('HIDE_ICONS' => 'N')
										);
