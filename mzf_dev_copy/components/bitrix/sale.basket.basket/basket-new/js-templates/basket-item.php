...
<script id="basket-item-template" type="text/html">
	<div class="card-horizontal basket-items-list-item-container{{#SHOW_RESTORE}} basket-items-list-item-container-expend{{/SHOW_RESTORE}}"
		...
		{{/SHOW_RESTORE}}
		{{^SHOW_RESTORE}}
			<div class="card card--product mb-4 border-0 basket-items-list-item-descriptions">
				<div class="row g-0 basket-items-list-item-descriptions-inner" id="basket-item-height-aligner-{{ID}}">
					<?
					if (in_array('PREVIEW_PICTURE', $arParams['COLUMNS_LIST']))
					{
						...
						<div class="col-md-4">
							...
							<img class="basket-item-image card-img-top" alt="{{NAME}}"
                                                ...
                                                {{#COLUMN_LIST}}
                                                    ...
                                                    {{#IS_TEXT}}
                                                        <div class="basket-item-property-custom basket-item-property-custom-text
                                                            {{#HIDE_MOBILE}}hidden-xs{{/HIDE_MOBILE}}"
                                                            data-entity="basket-item-property">
                                                            <div class="basket-item-property-custom-name h2"></div>
