...
<div class="row">
        <div class="col-lg-6 offset-lg-3 text-center">
            ...
            <p>Если в корзине были товары – <a href="/personal/">войдите</a>, чтобы посмотреть ранее добавленные товары или вернитесь в каталог. Приятных покупок!</p>
            <div class="row mt-4">
                <div class="col-lg-4 offset-lg-2">
                    <a href="/zerkala/" class="btn btn-primary d-block">Каталог</a>
                </div>
                <div class="col-lg-4">
                    <a href="/personal/" class="btn btn-outline-primary d-block">Личный кабинет</a>
                </div>
            </div>
        </div>
    </div>
