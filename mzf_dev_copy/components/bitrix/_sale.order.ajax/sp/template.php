...
<!--                    <div class="row">-->
<!--                        <div class="col-lg-6">-->
<!--                            <input class="form-control form-control-sm form-control--light d-block" name="PHONE" placeholder="Номер телефона">-->
<!--                        </div>-->
<!--                        <div class="col-lg-6">-->
<!--                            <div class="d-grid">-->
<!--                                <input class="btn btn-primary d-block" type="submit" name="sendsms" value="Выслать код SMS">-->
<!--                            </div>-->
<!--                        </div>-->
<!--                    </div>-->
<!--                </form>-->
<!--                <form method="post" action="podtver.php" target="ifr">-->
<!--                    <table>-->
...
<!--                    </div>-->
                    <div class="md-d-flex">
                        <p>Нажимая кнопку «Оформить заказ», вы принимаете условия<a href="/info/">“Политики
                                конфиденциальности”</a></p>

                        <a href="javascript:void(0)" style="margin: 10px 0"
                           class="pull-right btn btn-primary btn-sm d-block">
                            <?= $arParams['MESS_ORDER'] ?>
                        </a>
                    </div>
                </div>
