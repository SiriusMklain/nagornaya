...
if (strlen($request->get('ORDER_ID')) > 0) {
    ...
    <form action="<?= POST_FORM_ACTION_URI ?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form"
        ...
        <div id="bx-soa-order" class="row bx-<?= $arParams['TEMPLATE_THEME'] ?>" style="opacity: 0">
            <!--	MAIN BLOCK	-->
            <div class="col-xs-12 col-sm-12 col-md-8 bx-soa">
                ...
                <? else: ?>
                    ...
                    <script>
                        $(document).ready(function() {
                            if ($("#ID_DELIVERY_ID_62").attr("checked") == 'checked') {
                                $('.deliverOrder').remove();
                            }
                        })
                    </script>
                ...
                <div id="bx-soa-orderSave">
                    ...
                    <div class="justify-content-between row pt-4">
                        <div class="col-auto">
                            <a class="btn btn-primary postsms mb-2">
                                Получить код смс
                            </a>
                        </div>

                        <div class="col-auto postcod  visually-hidden">
                            <div class="d-flex justify-content-between">
                                <input type="text" class="form-control codesms me-2" placeholder="Введите код из СМС">
                                <a class="btn btn-success postcode" >Подтвертить код смс</a>
                            </div>
                        </div>
                    </div>
...
<!--                    <script>-->
<!--                        $(document).ready(function() {-->
<!--                           if ($('.checkedDeliver').find('#ID_DELIVERY_ID_62')) {-->
<!--                               $('.deliverOrder').remove();-->
<!--                           }-->
<!--                        })-->
<!--                    </script>-->

                    <div class="modal card-primary" tabindex="-1">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title text-center">Оформить</h5>
                                </div>
                                <div class="modal-body">
                                    <h4 class="text-center">Телефон подтвержден</h4>
                                    <p>Нажимая кнопку «Оформить заказ», вы принимаете условия<a href="/info/" target="_blank">“Политики
                                            конфиденциальности”</a></p>
                                </div>
                                <div class="modal-footer d-flex justify-content-center">
                                    <a href="javascript:void(0)" style="margin: 10px 0"
                                       class="pull-right btn btn-primary d-block" data-save-button="true">
                                        <?= $arParams['MESS_ORDER'] ?>
                                    </a>
                                </div>
                            </div>
            ...
            <!--	SIDEBAR BLOCK	-->
            <div id="bx-soa-total" class="col-xs-12 col-sm-12 col-md-4 bx-soa-sidebar card card--white">
                <h2>Информация о заказе</h2>
                <div class="bx-soa-cart-total-ghost"></div>
                <div class="bx-soa-cart-total"></div>
            </div>

            <div class="card card-tab shadow-sm border-0 h-100 mb-4">
                <div class="card-body">
                    <div class="card-icon">
                        <img alt="ОПИСАНИЕ ПРОЦЕССА ПЕРЕДАЧИ ДАННЫХ" src="/local/templates/mzf_dev_copy/images/new/payments/payment.png" class="img-fluid">
                    </div>
                    <h4 class="card-title">ОПИСАНИЕ ПРОЦЕССА ПЕРЕДАЧИ ДАННЫХ</h4>
                    <p>
