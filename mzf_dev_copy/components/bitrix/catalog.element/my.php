            ...
            <div class="col-lg-6 col-xl-5 offset-xl-1">
                <div class="row">
                    ...
                    <div class="product__buttons product__buttons-see" id="<?= $itemIds['BASKET_ACTIONS_ID'] ?>">
                        ...
                        <a class="btn btn-outline-primary btn-one" data-bs-toggle="modal" data-bs-target="#exampleModal">Купить в 1 клик</a>
                        <!-- Modal -->
                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Купить в 1 клик</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body ">
                                        <div class="modal fade zayavka-suc_contact card--primary" tabindex="-1" role="dialog" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="form-modal__modal-header form-modal__result-zayavka">
                                                        ...
                                                        <div>
                                                            <button type="button" class="close form-modal__contact-close" data-dismiss="modal"
                                                                    aria-label="Close">
                                                            </button>
                                                        </div>
                                                    </div>
                                        ...
                                        <form class="oneclick_form" method="POST" action="/local/ajax/oneclick.php">
                                            <input  id="textOne" name="URLPRODUCT" type="hidden" class="form-control form-control--light" value="<?= $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI'] ?>">
                                            <div class="mb-4">
                                                <label for="text" class="form-label">Имя</label>
                                                <input id="nameOne" type="text" name="NAME" class="form-control form-control--light" required>
                                            </div>
                                            <div class="mb-4">
                                                <label for="phone" class="form-label">Телефон</label>
                                                <input  id="phoneOne" name="PHONE" type="tel" class="form-control form-control--light" required>
                                            </div>
                                            <div class="mb-4">
                                                <label for="email" class="form-label">Email</label>
                                                <input  id="emailOne" name="EMAIL" type="email" class="form-control form-control--light" required>
                                            </div>
                                            ...
                                            <div class="form-check form-check-contact mb-4">
                                                <input id="checkbox_contact" type="checkbox" class="form-check-input" checked>
                                                <label class="form-check-label" for="privacy">Нажимая кнопку «Оставить заявку», вы принимаете условия <a target="_blank" href="/info/" class="text-primary">“Пользовательского соглашения”</a></label>
                                            </div>

                                            <div class="d-grid">
                                                <div class="oneclick__input-submit d-grid btn btn-outline-primary">Оставить заявку</div>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <li class="list-attribute__item">
                                ...
                                <span class="list-attribute__line"></span>
                                <span class="list-attribute__value"><a target="_blank" class="text-decoration-underline" href="/info/instruction/instruction .pdf">смотреть</a></span>
                            </li>
                        ...
                        <div <?=($arResult['SHOW_REVIEWS'] == 'Y') ? 'class="col-lg-6 col-xl-5 offset-xl-1"' : 'class="col-lg-6"'?>   >
                            ...
                            <form class="callback_form" method="POST" action="/local/ajax/handler-form.php">
                                ...
                                <div class="form-check form-check--primary mb-4">
                                    ...
                                    <label class="form-check-label" for="privacy">Нажимая на кнопку “Оставить отзыв” Вы принимаете условия <a href="#">“Политики конфиденциальности”</a></label>
                                </div>
