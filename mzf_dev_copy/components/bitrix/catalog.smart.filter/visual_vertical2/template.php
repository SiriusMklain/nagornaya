...
?>
<div class="bx_filter <?=$templateData["TEMPLATE_CLASS"]?> filter__body" data-scrollbar>
	<div class="bx_filter_section">
		<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
            ...
            <div class="">
				...
				<div class="bx_filter_block">
					<div class="bx_filter_parameters_box_container row g-3">
                        <div class="col-md-6">
						    <input class="btn btn-primary btn-sm d-block btn-submit" type="submit" id="set_filter" name="set_filter" value="<?=GetMessage("CT_BCSF_SET_FILTER")?>" />
                        </div>
                        <div class="col-md-6">
						    <input class="btn btn-outline-primary btn-sm d-block btn-reset" type="submit" id="del_filter" name="del_filter" value="<?=GetMessage("CT_BCSF_DEL_FILTER")?>" />
                        </div>
