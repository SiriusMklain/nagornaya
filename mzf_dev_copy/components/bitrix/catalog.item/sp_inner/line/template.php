...
<div class="line-section-item-row row product-item">
    ...
    <div class="line-properties-item col-xs-12 col-md-6">
        <?
        if ($item['LABEL'])
			{
				?>
        ...
        ?>
		<div class="line-section-title product-item-title">
			<? if ($itemHasDetailUrl): ?>
        ...
        <div class="product-line-price product-item-info-container product-item-price-container" data-entity="price-block">
							<?
							...
							?>
                                                                <span class="price-shild">Цена:</span>
							<span class="line-product-item-price-current" id="<?=$itemIds['PRICE']?>">
								<?
								if (!empty($price))
								{
	...
	?>
    <div style="display:none!important" class="col-xs-12 col-sm-6 col-md-3 col-lg-3<?=($showPropsBlock || $showSkuBlock ? '' : ' col-md-offset-6 col-lg-offset-7')?>">
