...
?>
		...
		<? if ($itemHasDetailUrl): ?>
		<a class="product-item-image-wrapper card-img" href="<?=$item['DETAIL_PAGE_URL']?>" title="<?=$imgTitle?>"
		...
		<? endif; ?>
			...
			<span class="product-item-image-original card-img-top" id="<?=$itemIds['PICT']?>"
				style="background-image: url('<?=CFile::ResizeImageGet(CFile::GetFileArray($item['PREVIEW_PICTURE']["ID"]), array("width" => 306, "height" => 296), BX_RESIZE_IMAGE_EXACT, true)["src"]?>'); <?=($showSlider ? 'display: none;' : '')?>">
			</span>
			<?
			if ($item['SECOND_PICT'])
			{
...
<? endif; ?>
    <p class="card-attribute"><?= $arResult['ITEM']['PROPERTIES']['HEIGHTS']['VALUE'] ?>x<?= $arResult['ITEM']['PROPERTIES']['WIDTHS']['VALUE'] ?></p>
    <div>
        <div class="card-info">
            <?
                    ...
                    case 'buttons':
                        ...
                        <div class="product-item-info-container" data-entity="buttons-block">
                            ...
                            if (!$haveOffers)
                            {
                                if ($actualItem['CAN_BUY'])
                                {
                                    ...
                                    <div id="<?=$itemIds['BASKET_ACTIONS']?>">
                                        <a class="btn btn-primary btn-circle <?=$buttonSizeClass?>" id="<?=$itemIds['BUY_LINK']?>"
                                ...
                                {
                                    ?>
                                    <div id="123" class="product-item-button-container">
                                        <?
                                        if ($showSubscribe)
                                        {
                            ...
                            else
                            {
                                ...
                                ?>
                                <div id="555">
                                    <a href="<?=$item['DETAIL_PAGE_URL']?>" class="btn btn-primary btn-circle"><i class="fas fa-arrow-right"></i></a>
                                </div>
                                <?
