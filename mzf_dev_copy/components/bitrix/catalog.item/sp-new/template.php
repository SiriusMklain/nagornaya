...
if (isset($arResult['ITEM']))
{
	...
	//print_r($item['FAVORITES']);

	?>

	<div class="card card--product"
		id="<?=$areaId?>" data-entity="item">
        <a data-item="<?=$item['ID']?>" href="#" class="btn btn-light btn-favor btn-wish favor <?=favorites($item['ID'])?>">
   ...
   $component,
	...
	<?
	unset($item, $actualItem, $minOffer, $itemIds, $jsParams,$class);
}