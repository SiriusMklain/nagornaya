...
<div class="card-body" id="bx-set-const-<?=$curJsId?>">
    <h5 class="card-title"><?=GetMessage("CATALOG_SET_BUY_SET")?></h5>
    <div class="bg-white additionally" id="constructor">
    ...
    <div class="row align-items-center mt-3">
        <div class="price__current product__price">
            <ul class="list-attribute list-attribute--primary list-price">
                <li class="list-price__item" style="display: <?=($arResult['SHOW_DEFAULT_SET_DISCOUNT'] ? 'table-row' : 'none'); ?>;">
                    ...
                    <span class="list-price__value">
                        <strong data-role="set-old-price"><?=$arResult["SET_ITEMS"]["OLD_PRICE"]?></strong>
                    </span>
                </li>
                <li class="list-price__item list-attribute__item">
                    <span class="list-attribute__name list-price__name"><?=GetMessage("CATALOG_SET_SET_PRICE")?></span>
                    <span class="list-attribute__line"></span>
                    <span class="list-attribute__value list-price__value" data-role="set-price">
