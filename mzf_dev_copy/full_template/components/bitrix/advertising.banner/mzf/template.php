...
<div id="carousel-<?=$arResult['ID']?>" class="carousel <?=$arParams['BS_EFFECT']?><?=$arParams['BS_HIDE_FOR_TABLETS']?><?=$arParams['BS_HIDE_FOR_PHONES']?>" data-interval="<?=$arParams['BS_INTERVAL']?>" data-wrap="<?=$arParams['BS_WRAP']?>" data-pause="<?=$arParams['BS_PAUSE']?>" data-keyboard="<?=$arParams['BS_KEYBOARD']?>" data-ride="carousel">
	...
	<div class="carousel-inner" role="listbox">
            <?/*<div class="item active">
				<iframe src="https://www.google.com/maps/embed?pb=!4v1555570117857!6m8!1m7!1sCAoSLEFGMVFpcE5RNVZYS05KX1dlSHB3aHE4RGE2bEphbXRzZDdBUmRMWVhYYmV2!2m2!1d55.67941200216029!2d37.6054790026277!3f132.43193676949474!4f1.6162634462708922!5f0.7820865974627469" width="100%" height="630" frameborder="0" style="border:0" allowfullscreen>
			</iframe>

            </div>
<div class="item active">
<iframe src="https://yandex.ru/map-widget/v1/-/CCbUmJ5o" width="100%" height="357px" frameborder="0" allowfullscreen="false"></iframe>
</div>*/?>
...
<div class="item">
<iframe src="https://zerkala.ru/virtual_tour/index.html" width="100%" height="357px" frameborder="0" allowfullscreen="false"></iframe>
</div>
		<?}else{?>
<div class="item">
	<?=$banner?>
...
$(document).ready(function () {
    if ($(window).width() > 768) {
        ...
        var obj2 = $('#stop-sticky');
        var offset2 = obj2.offset();
        var topOffset2 = offset2.top;
        var marginTop2 = obj2.css("marginTop");

        $(window).scroll(function () {
            var scrollTop = $(window).scrollTop();

            if (scrollTop >= topOffset + 700) {
            ...
            if (scrollTop >= topOffset2 - 790) {
                console.log(topOffset2);
                obj.css({
                    top: 1007,
                    position: 'relative',
                });
